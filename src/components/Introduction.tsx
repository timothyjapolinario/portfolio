...
const Introduction = () => {
  return (
    <div className="text-white text-[5vh]">
      ...
      <div>
        <span className="text-[#00a767] font-bold">Timothy</span>, Software Developer
      </div>
      <p className="text-[3vh] text-gray-600">
        Equipped with modern technologies, I give life to your amazing web application ideas.
      </p>
