...
const PhoneComponent = () => {
  return (
    <div className="h-screen md:h-full bg-[#212121] flex flex-1 flex-col rounded-[40px] justify-evenly items-center text-white border-solid border-gray-600 border-4 p-4">
      <div className="flex space-x-5">
        <h1 className="md:text-[3.2vh] font-bold">Timothy</h1>
        <p className="md:text-[2vh]">Software Developer</p>
      </div>
